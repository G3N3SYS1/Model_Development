...
def export(
    ...
    YOLO format using images.split() before feeding to YOLOv8 for training.
...
def split(images_directory_path, annotations_path, output_dir):
    ...
    :param annotations_path: Path to labels_original.json of COCO dataset
    (i.e. /home/kai/projects/lamp_detection/test_data/labels_original.json)
